...
public class Kitchen extends Mob {
    ...
    private static final Image IMAGE = ImageLoader.IMAGE_LOADER.getImage("entity/kitchen");
    ...
    public Kitchen(double x, double y, Level level, Keyboard keyboard, PlayerProperties properties) {
